...
import { ArrowRight, Play, Star, Shield, Zap, Database, ChevronLeft, ChevronRight, Settings, CheckCircle, Users, BarChart3 } from "lucide-react";
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/95 backdrop-blur-lg border-b border-gray-200' : 'bg-transparent'}`}>
        <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/admin/login">
              <Button variant="ghost" size="icon" className="text-gray-500 hover:text-emerald-600 hover:bg-emerald-50 transition-all duration-300" id="admin-login-btn">
                <Settings className="w-5 h-5" />
              </Button>
            </Link>
            <Link to="/user/login">
              <Button variant="outline" className="border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white transition-all duration-300" id="login-btn">
                Увійти
              </Button>
            </Link>
        ...
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link to="/user/register">
                <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold px-8 py-4 text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-emerald-500/25" id="get-started-btn">
                  Розпочати безкоштовно
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Button variant="outline" size="lg" className="border-2 border-gray-300 text-gray-700 hover:border-emerald-500 hover:text-emerald-600 px-8 py-4 text-lg transition-all duration-300" id="watch-demo-btn">
      ...
      <section id="features" className="py-20 px-6 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => <Card key={index} className="border-0 shadow-lg bg-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" id={`feature-card-${index}`}>
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=600&h=400&fit=crop" alt="XML Processing" className="rounded-2xl shadow-2xl" />
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/user/register">
              <Button size="lg" className="bg-white text-emerald-600 hover:bg-gray-100 font-bold px-12 py-4 text-lg transition-all duration-300 transform hover:scale-105 shadow-lg" id="cta-register-btn">
                Розпочати безкоштовно
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
