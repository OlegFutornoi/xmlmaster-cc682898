...
import { ArrowLeft, Save, Plus, FileCode, Upload, Link } from 'lucide-react';
            ...
            <Card className="border-0 shadow-sm bg-white">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => setIsAddParameterDialogOpen(true)} size="sm" className="bg-blue-600 hover:bg-blue-700 text-white" id="add-parameter-button">
              ...
              <CardContent>
                {isLoadingParameters ? <div className="text-center py-8">
                  ...
                  </div> : <TemplateParametersTable parameters={parameters} onUpdateParameter={updateParameter} onDeleteParameter={deleteParameter} />}
              </CardContent>
            </Card>
          </div>
