...
const UserTariffs = () => {
  ...
  const [dialogMode, setDialogMode] = useState<'view' | 'activate'>('view');

  const { planLimitations, planItems, isLoading: detailsLoading } = usePlanDetails(selectedPlanId);

  const handlePlanClick = (planId: string) => {
    console.log('Plan activation clicked for plan:', planId);
  ...
  const handleActivatePlan = async () => {
    ...
    try {
      console.log('Activating plan:', selectedPlanId);
